...
STRATS = [
    ...
    dict(key="us_stocks", label="S3 US Stock Momentum", pf="portfolio_us_stocks.json",
         ...
         block="Reconciliation in progress: de-leverage sells (TSLA 47, JPM 59, DBA 733, AVGO 10) queued 2026-07-11, fill at Monday open; then run reconcile_s3.py and split AVGO claim with S4 (shared Alpaca account)", note=""),
    ...
    dict(key="strategy16", label="S16 MACD-HMM Router", pf="portfolio_strategy16.json",
         ...
         block=None, note="60d in-sample backtest; params tuned July 2026 -- treat backtest as ceiling"),
    dict(key="strategy17", label="S17 FIBRAs Dynamic", pf="portfolio_strategy17.json",
         ledger="transactions_strategy17.md", initial=100000.0, ccy="MXN", inception="2026-07-12",
         ms_key="s17_nav_usd", bt=dict(window=4.03, sharpe=0.10, cagr=0.1032, max_dd=-0.1693),
         block=None, note="Dynamic FIBRA portfolio based on quality screens"),
    dict(key="strategy19", label="S19 Particle Filter QQQ", pf="portfolio_strategy19.json",
         ledger="transactions_strategy19.md", initial=200000.0, ccy="MXN", inception="2026-07-13",
         ms_key="s19_nav_usd", bt=dict(window=16.41, sharpe=0.31, cagr=0.2192, max_dd=-0.5178),
         block=None, note="Particle Filter systematic QQQ allocation"),
    dict(key="strategy20", label="S20 Hurst Exponent Dynamic", pf="portfolio_strategy20.json",
         ledger="transactions_strategy20.md", initial=200000.0, ccy="MXN", inception="2026-07-13",
         ms_key="s20_nav_usd", bt=dict(window=16.41, sharpe=0.34, cagr=0.2429, max_dd=-0.6371),
         block=None, note="Hurst Exponent dynamic QQQ allocation"),
    dict(key="strategy21", label="S21 Golden Entropy", pf="portfolio_strategy21.json",
         ledger="transactions_strategy21.md", initial=200000.0, ccy="MXN", inception="2026-07-13",
         ms_key="s21_nav_usd", bt=dict(window=16.41, sharpe=0.03, cagr=0.1085, max_dd=-0.7025),
         block=None, note="Shannon Entropy dynamic allocation"),
    dict(key="strategy22", label="S22 Walk-Forward ML", pf="portfolio_strategy22.json",
         ledger="transactions_strategy22.md", initial=200000.0, ccy="MXN", inception="2026-07-13",
         ms_key="s22_nav_usd", bt=dict(window=16.42, sharpe=0.26, cagr=0.2113, max_dd=-0.5866),
         block=None, note="Adaptive Random Forest Walk-Forward classifier"),
    dict(key="strategy23", label="S23 Calculus S&R", pf="portfolio_strategy23.json",
         ledger="transactions_strategy23.md", initial=200000.0, ccy="MXN", inception="2026-07-15",
         ms_key="s23_nav_usd", bt=dict(window=16.0, sharpe=0.42, cagr=0.3082, max_dd=-0.7053),
         block=None, note="Tuned 2026-07-15 to 35-day window length"),
    dict(key="strategy24", label="S24 ML Classifier", pf="portfolio_strategy24.json",
         ledger="transactions_strategy24.md", initial=200000.0, ccy="MXN", inception="2026-07-15",
         ms_key="s24_nav_usd", bt=dict(window=0.24, sharpe=0.59, cagr=0.3737, max_dd=-0.1192),
         block=None, note="Tuned 2026-07-15 to 35-bar Golden Ratio scale + 26-bar min hold"),
    dict(key="strategy25", label="S25 Golden MACD BMV", pf="portfolio_strategy25.json",
         ledger="transactions_strategy25.md", initial=200000.0, ccy="MXN", inception="2026-07-15",
         ms_key="s25_nav_usd", bt=dict(window=16.0, sharpe=0.45, cagr=0.2086, max_dd=-0.1869),
         block=None, note="Golden MACD parameters (55 EMA, 13/34/8) on BMV Stocks"),
    dict(key="strategy27", label="S27 Golden Hurst", pf="portfolio_strategy27.json",
         ledger="transactions_strategy27.md", initial=200000.0, ccy="MXN", inception="2026-07-15",
         ms_key="s27_nav_usd", bt=dict(window=16.0, sharpe=0.48, cagr=0.0540, max_dd=-0.4381),
         block=None, note="Golden Hurst parameter (55-day window, 21/55 EMA) on QQQ Index"),
    dict(key="strategy29", label="S29 Golden Stat-Arb", pf="portfolio_strategy29.json",
         ledger="transactions_strategy29.md", initial=200000.0, ccy="MXN", inception="2026-07-15",
         ms_key="s29_nav_usd", bt=dict(window=5.0, sharpe=5.0354, cagr=2.5345, max_dd=-0.0001),
         block=None, note="Golden Cointegration parameter (89-day lookback) on Pairs"),
    dict(key="strategy30", label="S30 Golden MACD US", pf="portfolio_strategy30.json",
