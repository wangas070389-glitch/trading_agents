...
| :--- | :---: | :---: | ---: | :---: | :---: |
| **GRUMAB.MX** | 1.00 | $268.28 | $268.28 | 2.8% | 0.715 |
| **ORBIA.MX** | 288.36 | $24.31 | $7,010.12 | 30.0% | 1.000 |
| **BBAJIOO.MX** | 111.39 | $58.14 | $6,476.45 | 30.0% | 0.826 |
| **GFNORTEO.MX** | 32.26 | $200.90 | $6,481.76 | 30.0% | 0.169 |
...
| **CEMEXCPO.MX** | SELL / AVOID | $20.74 | -0.474 | BEAR | BEAR | Low conviction (DCS=-0.474 < 0.15) and Bear trend (Close <= SMA 100) |
| **CUERVO.MX** | BUY / HOLD | $15.51 | 0.255 | BULL | BULL | Strong conviction (DCS=0.255) and bull trend (Close > SMA 100) |
| **FEMSAUBD.MX** | SELL / AVOID | $219.70 | 0.045 | BULL | BEAR | Low conviction (DCS=0.045 < 0.15) |
| **GAPB.MX** | SELL / AVOID | $382.13 | 0.012 | BEAR | BEAR | Low conviction (DCS=0.012 < 0.15) and Bear trend (Close <= SMA 100) |
| **GCC.MX** | SELL / AVOID | $201.14 | -0.106 | BULL | BEAR | Low conviction (DCS=-0.106 < 0.15) |
...
| **PINFRA.MX** | SELL / AVOID | $276.82 | 0.177 | BEAR | BEAR | Bear trend (Close <= SMA 100) |
| **VESTA.MX** | SELL / AVOID | $59.65 | 0.162 | BEAR | BEAR | Bear trend (Close <= SMA 100) |
| **WALMEX.MX** | SELL / AVOID | $50.34 | 0.133 | BEAR | BULL | Low conviction (DCS=0.133 < 0.15) and Bear trend (Close <= SMA 100) |
