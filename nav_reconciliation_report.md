...
| S2 1d MACD Systematic | 414 | 5 | 9 | MISMATCH | 42,721.67 MXN |
...
| ↳ cash/evidence |  |  |  | Line 5: column count does not match header; Line 6: column count does not match header; Line 7: column count does not match header; Line 8: column count does not match header; Line 9: column count does not match header; cash discrepancy -151008.72 |  |
...
| S8 Dividend Quality | 363 | 4 | 4 | VERIFIED | -154,936.04 MXN |
| S9 AI Regime Stat-Arb | 409 | 0 | 0 | MISMATCH | -28,856.94 MXN |
...
| S10 Intraday VWAP | 192 | 0 | 0 | MISMATCH | -964.20 MXN |
...
| S11 Intraday CCI-ADX | 350 | 0 | 0 | MISMATCH | -1,012.71 MXN |
...
| S12 VTTL Trend+Vol | 344 | 1 | 1 | MISMATCH | -70,795.12 MXN |
| ↳ cash/evidence |  |  |  | ; cash discrepancy -0.07 |  |
| S13 CARA Cross-Asset | 349 | 1 | 1 | UNRESOLVED | -73,125.47 MXN |
| ↳ cash/evidence |  |  |  | Currency-specific balances require an FX ledger reconciliation; cash discrepancy None |  |
| S14 HEDGE Aggregator | 679 | 1 | 1 | UNRESOLVED | -58,449.91 MXN |
...
| S15 TRACK Tracker | 679 | 1 | 1 | UNRESOLVED | -58,468.56 MXN |
| ↳ cash/evidence |  |  |  | Line 7: unsupported action BUY_USD; Line 400: unsupported action BUY_USD; Line 585: unsupported action SELL_USD; Currency-specific balances require an FX ledger reconciliation; cash discrepancy None |  |
| S16 HMM Intraday Router | 314 | 0 | 0 | MISMATCH | -1,626.49 MXN |
...
| S17 FIBRAs Dynamic | 181 | 2 | 2 | MISMATCH | 52,063.12 MXN |
...
| S20 Hurst Exponent Dynamic | 15 | 0 | 0 | MISMATCH | -23,659.54 MXN |
| ↳ cash/evidence |  |  |  | Line 5: column count does not match header; cash discrepancy 200000.0 |  |
| S21 Shannon Entropy Dynamic | 44 | 1 | 0 | MISMATCH | -20,723.94 MXN |
| ↳ difference |  |  |  | TQQQ: ledger 59.4709, portfolio 0 |  |
| ↳ cash/evidence |  |  |  | Line 5: column count does not match header; cash discrepancy 200000.0 |  |
| S22 Walk-Forward ML | 127 | 0 | 0 | MISMATCH | 7,802.04 MXN |
| ↳ cash/evidence |  |  |  | Line 5: column count does not match header; cash discrepancy 200000.0 |  |
| S23 Calculus S&R | 146 | 1 | 1 | MISMATCH | -200,000.00 MXN |
| ↳ cash/evidence |  |  |  | Line 5: column count does not match header; cash discrepancy 200000.0 |  |
| S24 30m Random Forest | 72 | 1 | 1 | MISMATCH | -200,000.00 MXN |
| ↳ cash/evidence |  |  |  | Line 5: column count does not match header; cash discrepancy 200000.0 |  |
| S25 Golden MACD BMV | 270 | 0 | 0 | MISMATCH | -1,705.31 MXN |
| ↳ cash/evidence |  |  |  | Line 5: column count does not match header; cash discrepancy 200000.0 |  |
| S27 Golden Hurst | 257 | 0 | 0 | MISMATCH | 2,480.74 MXN |
| ↳ cash/evidence |  |  |  | Line 5: column count does not match header; cash discrepancy 200000.0 |  |
| S29 Golden Stat-Arb | 256 | 0 | 0 | MISMATCH | 2,480.72 MXN |
| ↳ cash/evidence |  |  |  | Line 5: column count does not match header; cash discrepancy 200000.0 |  |
| S30 Golden MACD US | 265 | 1 | 1 | MISMATCH | -18,077.16 USD |
