...
| S2 1d MACD Systematic | 398 | 5 | 9 | MISMATCH | 43,822.93 MXN |
...
| S8 Dividend Quality | 348 | 4 | 4 | VERIFIED | -155,018.27 MXN |
| S9 AI Regime Stat-Arb | 392 | 0 | 0 | MISMATCH | -30,734.80 MXN |
...
| S11 Intraday CCI-ADX | 335 | 0 | 0 | MISMATCH | -1,391.45 MXN |
...
| S12 VTTL Trend+Vol | 328 | 1 | 1 | VERIFIED | -98,839.93 MXN |
| S13 CARA Cross-Asset | 330 | 1 | 1 | UNRESOLVED | -99,803.02 MXN |
| ↳ cash/evidence |  |  |  | Currency-specific balances require an FX ledger reconciliation; cash discrepancy None |  |
| S14 HEDGE Aggregator | 646 | 1 | 1 | UNRESOLVED | -68,899.03 MXN |
...
| S15 TRACK Tracker | 646 | 1 | 1 | UNRESOLVED | -68,904.67 MXN |
| ↳ cash/evidence |  |  |  | Line 7: unsupported action BUY_USD; Line 400: unsupported action BUY_USD; Line 585: unsupported action SELL_USD; Currency-specific balances require an FX ledger reconciliation; cash discrepancy None |  |
| S16 HMM Intraday Router | 299 | 0 | 0 | MISMATCH | -1,998.23 MXN |
...
| S17 FIBRAs Dynamic | 166 | 2 | 2 | MISMATCH | 51,970.97 MXN |
...
| ↳ cash/evidence |  |  |  | Line 5: column count does not match header; cash discrepancy 200000.0 |  |
| S21 Shannon Entropy Dynamic | 29 | 1 | 0 | MISMATCH | -21,046.35 MXN |
| ↳ difference |  |  |  | TQQQ: ledger 59.4709, portfolio 0 |  |
| ↳ cash/evidence |  |  |  | Line 5: column count does not match header; cash discrepancy 200000.0 |  |
| S22 Walk-Forward ML | 112 | 0 | 0 | MISMATCH | 7,428.33 MXN |
| ↳ cash/evidence |  |  |  | Line 5: column count does not match header; cash discrepancy 200000.0 |  |
| S23 Calculus S&R | 132 | 0 | 0 | MISMATCH | 6,196.03 MXN |
| ↳ cash/evidence |  |  |  | Line 5: column count does not match header; cash discrepancy 200000.0 |  |
| S24 30m Random Forest | 72 | 1 | 1 | MISMATCH | -200,000.00 MXN |
| ↳ cash/evidence |  |  |  | Line 5: column count does not match header; cash discrepancy 200000.0 |  |
| S25 Golden MACD BMV | 255 | 0 | 0 | MISMATCH | -2,061.94 MXN |
| ↳ cash/evidence |  |  |  | Line 5: column count does not match header; cash discrepancy 200000.0 |  |
| S27 Golden Hurst | 242 | 0 | 0 | MISMATCH | 2,116.62 MXN |
| ↳ cash/evidence |  |  |  | Line 5: column count does not match header; cash discrepancy 200000.0 |  |
| S29 Golden Stat-Arb | 241 | 0 | 0 | MISMATCH | 2,116.60 MXN |
| ↳ cash/evidence |  |  |  | Line 5: column count does not match header; cash discrepancy 200000.0 |  |
| S30 Golden MACD US | 249 | 0 | 0 | MISMATCH | -223.47 USD |
