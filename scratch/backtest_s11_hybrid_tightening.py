...
def main():
    ...
    print(f"Downloading {tf} data for backtesting hybrid tightening model...")
    ...
    for date_str in backtest_dates:
        ...
        for i in range(len(group)):
            ...
            if active_position:
                ...
                # Dynamic profit stop tightening
                ...
                if is_stop_out or is_eod:
                    ...
                    if not should_hold_overnight:
                        ...
                        closed_trades.append({"pnl": pnl, "exit": "STOP_OUT" if is_stop_out else "EOD"})
                        trade_count += 1
                        active_position = None
                        current_portfolio_value = cash
            ...
            if not active_position and not is_eod:
                ...
                if side == "long":
                    if cci_tqqq >= 0.0:
                        ...
                        cash += val_credited
                        pnl = val_credited - active_position["allocated"]
                        closed_trades.append({"pnl": pnl, "exit": "CCI_ZERO"})
                        trade_count += 1
                        active_position = None
                        current_portfolio_value = cash
                else:
    ...
    print("\n" + "=" * 80)
    print("HYBRID STOP TIGHTENING MODEL FOR STRATEGY 11")
    print("=" * 80)
