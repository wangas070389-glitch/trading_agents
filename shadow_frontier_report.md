...
**Generated:** 2026-07-23 16:12:27 | Inception: 2026-07-14 (9 calendar days) | Virtual capital: $100,000 USD
...
| :--- | ---: | ---: |
| NAV | -- | $99,634.02 USD |
| Return since inception | -- | -0.37% |
| Ann. return | +14.67% | -- (<30d) |
| Ann. volatility | 6.66% | 6.16% |
| Sharpe (Rf 6.53%) | +1.22 | -2.70 |
...
## 6. Method notes
- USD-denominated; MXN sleeves converted at usd_mxn_rate (17.5020), so they carry FX exposure — same caveat as the frontier report.
