...
**Generated:** 2026-08-12 19:38:29 | Inception: 2026-07-14 (29 calendar days) | Virtual capital: $100,000 USD
...
| :--- | ---: | ---: |
| NAV | -- | $252,757.92 USD |
| Return since inception | -- | +152.76% |
| Ann. return | +14.67% | -- (<30d) |
| Ann. volatility | 6.66% | 117.25% |
...
| S2 MACD Systematic | 4.9% | 3.9% | -2.06% | 2026-08-12 | watchdog MXN/USD |
...
## 6. Method notes
- USD-denominated; MXN sleeves converted at usd_mxn_rate (17.0540), so they carry FX exposure — same caveat as the frontier report.
