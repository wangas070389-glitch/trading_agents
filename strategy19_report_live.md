...
**Execution Timestamp:** 2026-07-22 22:06:45 | **Strategy Version:** Live V1

## 1. Portfolio Summary
* **Total Portfolio NAV:** $192,621.03 MXN
* **Total Cash sweep Balance:** $0.00 MXN (Parked in Bondia compound at 6.53% APR)
* **Equity Exposure:** 100.0%
* **Asset Allocation Target:** QQQ
* **USD/MXN Exchange Rate:** 17.4020

## 2. Current Holdings
| Ticker | Shares Held | Buy Price (USD) | Last Price (USD) | Market Value (USD) | Market Value (MXN) | Target Weight |
| :--- | :---: | :---: | :---: | ---: | ---: | :---: |
| **QQQ** | 15.6928 | $730.25 | $705.35 | $11,068.90 | $192,621.03 | 100.0% |

## 3. Sequential Monte Carlo (SMC) Estimates
* **Latent Drift (Posterior $\hat{\mu}_t$):** +31.68% annualized
* **Latent Volatility (Posterior $\hat{\sigma}_t$):** 24.95% annualized
* **Probability of Bull Regime ($P(\mu_t > 0)$):** 75.9%
